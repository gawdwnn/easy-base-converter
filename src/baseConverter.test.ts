...
describe('convertFromBaseNToDecimal', () => {
  ...
  describe('When given a valid parameter to the method', () => {
...
describe('convertFromDecimalToBaseN()', () => {
  describe('When given a decimal number', () => {
    test('should convert it to base N number', () => {
...
describe('When given an invalid number in base N', () => {
  ...
  test('should throw an error indicating that there is more than one delimeter', () => {
    expect(() => converter.convertFromBaseNToDecimal('1101.10.11', 2)).toThrowError(
      'Number contains more than one delimeter',
    );
  });
  test('should throw an error indicationg that the number is valid', () => {
  ...
  test('should throw an error indicating that baseForm must be a number', () => {
    expect(() => converter.convertFromBaseNToDecimal('123', ('3' as unknown) as number)).toThrowError(
...
describe('When given a decimal number that is less than the base we want to convert', () => {
  test('should convert it to base N number and delete the zeros from the left', () => {
